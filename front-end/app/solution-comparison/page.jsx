...
export default function SolutionComparsion() {
        ...
        {domLoaded && (
          <div className="mt-10">
            <div className="bg-green-200 rounded-lg	shadow-lg mb-10">
              <div className="pt-6">
                <h1 className=" text-center text-4xl Roboto">Solutin ID 1</h1>
              </div>
              <StatsCards />
              <div className="flex justify-center  w-full mx-4 min-w-fit">
                <div className="bg-white mr-14  shadow-lg w-3/5">
                  <CostChart
                    costs={{ cost: 300000, profit: 3000 * 12, years: 10 }}
                  ></CostChart>
                </div>
                <div className="bg-white shadow-lg h-fit w-fit min-w-fit">
            ...
            <div className="bg-green-200 rounded-lg	shadow-lg mb-10">
              <div className="pt-6">
                <h1 className=" text-center text-4xl Roboto">Solutin ID 2</h1>
              </div>
